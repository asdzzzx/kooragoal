...
- داخل المجلد `wp-theme/kooragoal-theme` ستجد قالب ووردبريس متكامل يحمل نفس هوية Kooragoal مع تحديثات مباشرة كل 15 ثانية.
- قم بضغط المجلد `kooragoal-theme` بصيغة ZIP ثم ارفعه عبر لوحة تحكم ووردبريس (`المظهر > أضف جديد > رفع قالب`).
